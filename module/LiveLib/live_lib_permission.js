...
*/
let _live_lib_permission = function () {
  try {
    ...
    global.LiveLib.permissions.PermissionsTree = function (parent, value, not, childes, perm, e) {
      try {
        this.parent = parent;
        this.value = value;
        this.is_perm = !!perm;
        this.is_negative = !!not;
        this.childs = childes ? childes : new Set();
      } catch (err) {
        if (e) throw err;
    ...
    global.LiveLib.base.createClass(global.LiveLib.permissions.PermissionsTree);
    ...
    global.LiveLib.base.createClass(global.LiveLib.permissions.GroupManager);
